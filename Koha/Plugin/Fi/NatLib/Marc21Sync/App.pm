...
use base qw(
    ...
    Koha::Plugin::Fi::NatLib::Marc21Sync::App::RuntimeReport
    Koha::Plugin::Fi::NatLib::Marc21Sync::App::RuntimeTool
    Koha::Plugin::Fi::NatLib::Marc21Sync::App::RuntimeIntranetJS
    Koha::Plugin::Fi::NatLib::Marc21Sync::App::Interface
